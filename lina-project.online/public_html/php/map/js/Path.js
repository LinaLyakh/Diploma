...
elem.innerHTML = '<p id="infos">Выберите начальную точку и пункт назначения, затем выберите вид транспорта и нажмите «Найти».</p>';
...
function start() {
    ...
    {
        displayError('\n' +
            'Ошибка, ввод неправильный или пустой.');
    }
